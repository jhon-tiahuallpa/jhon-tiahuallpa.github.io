...
Rvest es un paquete incluido en tidyverse.
La pagina de github donde se ubica es: [https://github.com/tidyverse/rvest]  
...
library(distill)
library(rmarkdown)
render_site("acerca.Rmd")
```


Por lo general, comenzará el proceso de raspado con read_html(). Esto devuelve un objeto xml_document2 que luego manipulará usando funciones rvest:
```{r}
...
Otra forma de obtener el HTML es introducirlo directamente





Puedes ver el Video en: https://www.youtube.com/watch?v=NwtxrbqE2Gc
...
```
https://www.reddit.com/r/politics/comments/a1j9xs/partisan_election_officials_are_inherently_unfair/
